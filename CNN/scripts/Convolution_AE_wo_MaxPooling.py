...
sys.path.append('/home/nicolasf/research/dl4seas/dl4seas') 
from NN import *
from utils import *
...
# %% select one step (leadtime = 3 months), and only extract the variable 
...
# %% get the repeated datetimes (will be useful to sample repeatedly in Yds at some point)
